 ...
 <div class="row">       
        <p></p>
                    ...
                    <div class="row">
                        ...
                        <!-- 用圖檔(CHICKEN) -->
                            <h1><img src="assets/ico/supply.png" alt=""> </h1>                 
                        </div>
                    </div>
                        ...
                        <div class="col-sm-5 form-box">
                    		...
                    		<form role="form" name="user" action="save_user.php" method="post" class="user-form">
                                     ...
                                     <?php
                                          ...
                                          //執行 SQL 命令
                                          $sql = "SELECT * FROM commodity_supply ORDER BY supply_code DESC";    
            ...
            echo "<font color='#FFAA33'>Title：</font>  <font color='#FFFFFF'>".$row["supply_title"] ."</font><br>";
...
ability：</font>"  ;
            ...
            $j++;
                                          ...
                                          if ($page > 1)
                                            echo "<a href='supply_page.php?page=". ($page - 1) . "'>上一頁</a> ";
                                          ...
                                          for ($i = 1; $i <= $total_pages; $i++)
                                          {
                                            if ($i == $page)
                                              ...
                                              echo "<a href='supply_page.php?page=$i'>$i</a> ";
                                          }

                                          if ($page < $total_pages)
                                            echo "<a href='supply_page.php?page=". ($page + 1) . "'>下一頁</a> ";
                                          echo "</p>";
                                    ...
                                    ?>
                    			                    ...
                    			                    <hr>
                    									<!--Summit buttun-->
                                                			  ...
                                                			  <input type="button" value='post' onclick = "location.href='supply_published.php'">
                                                        </div>
                    									<p></p>	
