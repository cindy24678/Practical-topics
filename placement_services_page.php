      ...
      <div class="container">
        ...
        <div class="top-content">
                    ...
                    <div class="row">                                            <!-- 第二列 -->
                        ...
                        <div class="col-sm-7 form-box">                               <!-- 右邊 -->
                        	...
                        	<?php
                                          ...
                                          //執行 SQL 命令
                                          $sql = "SELECT supply_title,lan_listen,lan_say,lan_read,lan_write,update_time,supply_code FROM commodity_supply WHERE supplier = '$account'  ORDER BY supply_code DESC ";
          ...
          while ($row = mysqli_fetch_assoc($result) and $j <= $records_per_page)
          {
            ...
            echo "<td bgcolor=''" . $bg[$j - 1] ."<td> <font color='#FFAA33'>title：</font> <font color='#FFFFFF'>"  . $row["supply_title"] ."</font><br>";
            ...
            echo "<a href='save_new_personal_supply.php? supply_code=";
            echo $row["supply_code"];
            
            echo "'></a>";

    	    echo "<a href='save_revise_supply.php?supply_code=";
      	    echo $row["supply_code"] . "'> <input type='button' value='修改'></a>";			
    	    echo "<a href='show_personal_supply.php?supply_code=";
      	    echo $row["supply_code"] . "'> <input type='button' value='查看'></a>";	
          echo "<a href='delete_supply.php?supply_code=";
            echo $row["supply_code"] . "'> <input type='button' value='刪除'></a>"; 
          ...
          if ($page > 1)
            echo "<a href='placement_services_page.php?page=". ($page - 1) . "'>上一頁</a> ";
          ...
          for ($i = 1; $i <= $total_pages; $i++)
          {
            if ($i == $page)
              ...
              echo "<a href='placement_services_page.php?page=$i'>$i</a> ";   
          }
          
          if ($page < $total_pages)
            echo "<a href='placement_services_page.php?page=". ($page + 1) . "'>下一頁</a> ";      
