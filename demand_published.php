                    ...
                    <div class="row">
                        <div class="span10">
                                ...
                                <div class="col-sm-5 form-box">
                                    <div class="form-top">
                                        <div class="form-top-left">
                                            <!-- 用圖檔(Register) -->
                                            <h3><img src="assets/ico/demand.png" alt=""></h3>
                                        </div>
                            ...
                            <div class="form-bottom">
			                    <form role="form" id= "commodity_demand" name="commodity_demand" action="save_demand.php" method="post" class="user-form" >
			                    	<hr>
			                    	<div class="form-group">
			                    		<label class="sr-only" for="form-first-name">enter new title</label>
			                        	<input type="text" id="demand_title" name="demand_title" placeholder="enter new title..." class="form-first-name form-control"  >
			                        </div>

			                        <div class="form-group">

			                        	<textarea type="textarea" id="demand_description" name="demand_description" placeholder="enter new description..." class="form-first-name form-control"   cols="43" rows="5"></textarea>
			                        </div>
                            ...
                            <div class="span2">
                                            <!-- 用圖檔(Register) -->
                                <h3><img src="assets/img/許願池.png" alt="" width="550" height="550"></h3>
