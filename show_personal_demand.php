<?php 
  ...
  $link = create_connection();
      ...
      //執行SQL查詢
      $sql = "SELECT * FROM  commodity_demand WHERE demand_code = ' $demand_code'";
   ...
   <p align="navbar-left"><br>                            <!-- 右邊 -->
    ...
    <table  align="center" width="1000" height="400">
       ...
       <tr class="" style="border:hidden">
             <td> <font color="#FFAA33">demander：</font></td> 
             <td> <font color='#FFFFFF'>  <?php echo $demander ?> </font><br></td>
       ...
       <tr class="" style="border:hidden">
             ...
             <td> <font color='#FFFFFF'>  <?php echo $demand_description ?> </font>  </td> 
       </tr>
...
<div>
  ...
  <?php 
      ...
      //執行 SQL 命令
      $sql = "SELECT * FROM discuss_demand WHERE demand_code = ' $demand_code'";
      $result = execute_sql($link, "chicken", $sql);
     ...
     //$total_records = mysqli_num_rows($result);
       ...
       if (mysqli_num_rows($result) <> 0)
      {
        ...
        while ($row = mysqli_fetch_assoc($result))
        {
          ...
          echo "<td bgcolor='#DDDDDD'>" . $row["demand_reply"] .  "</td>";
    ...
    <form name="discuss_demand" method="post" action="save_demand_reply.php">
       <input type="hidden" name="demand_code" value="<?php echo $demand_code ?>">
      <table  width="800" align="center" cellspacing="0">
     
        <tr bgcolor="#FFAA33">
          <td width="15%"><font color='#000000'>回覆</font></td>
          <td width="85%"><input name="demand_reply" type="text" size="80"></td>
        </tr>
