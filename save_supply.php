<?php
  ...
  $link = create_connection();
    ...
    //執行 SQL 命令，新增此帳號
    $sql = "INSERT INTO commodity_supply (supplier, supply_title, supply_description, language, lan_listen, lan_say, lan_read, lan_write, country, on_line, record, face_to_face, teaching_method, teaching_time, supply_time, update_time) VALUES ('$supplier', '$supply_title', '$supply_description', '$language', '$lan_listen', '$lan_say', '$lan_read', '$lan_write' ,'$country' ,'$on_line', '$record', '$face_to_face', '$teaching_method', '$teaching_time','$supply_time', '$update_time' )";
...
<html lang="en">
  ...
  <body bgcolor="#FFFFFF">
    ...
    <p align="center"><img src="assets/ico/成功雞.png" alt="" width="250" height="200"> 

		<table class="table">
		 <p align="navbar-left"><br>
			...
			<h4><font color="#FFFFFF"><?php echo $supply_title ?></font></h4>
				...
				<table  align="center" width="1000" height="400">
					...
					<tr class="" style="border:hidden">
						...
						<td><font color="#FFFFFF"><?php echo $supply_description ?></font><br></td>
       ...
       <tr class="" style="border:hidden">
             ...
             <td > <font color='#FFFFFF'>  <?php echo $country ?>  </font> </td>
					...
					<tr  class="" style="border:hidden">
						<td><font color="#FFAA33">supply time：</td>
						<td><font color="#FFFFFF"><?php echo $supply_time ?></font><br></td>
      ...
      <div class="top-big-link">
          <input type="button" value="go back supply page" style="background-color:#0072E3" class="btn" onclick="location.href='supply_page.php'"">
