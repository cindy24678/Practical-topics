<?php
  ...
  $link = create_connection();
    ...
    //執行 SQL 命令，新增此帳號
    $sql = "INSERT INTO commodity_supply (supplier, supply_title, supply_description, language, lan_listen, lan_say, lan_read, lan_write, on_line, record, face_to_face, teaching_method, teaching_time, supply_time, update_time) VALUES ('$supplier', '$supply_title', '$supply_description', '$language', '$lan_listen', '$lan_say', '$lan_read', '$lan_write', '$on_line', '$record', '$face_to_face', '$teaching_method', '$teaching_time','$supply_time', '$update_time' )";
